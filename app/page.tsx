...
export default function Home() {
 const [checkIn, setCheckIn] = useState('');
  ...
  const destinations = [
    ...
    { name: 'London', image: 'https://images.unsplash.com/photo-1576343547429-1a9ac89d7013?q=80&w=1548&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { name: 'Rome', image: 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
    { name: 'Bali', image: 'https://images.unsplash.com/photo-1506812574058-fc75fa93fead?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' },
  ];
  ...
  return (
    <>
      ...
      {/* Footer */}
      <footer className="bg-cyan-900 text-white py-8 mt-16">
